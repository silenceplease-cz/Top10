...
* Sestavte technické požadavky, včetně funkčních a nefunkčních bezpečnostních požadavků. OWASP doporučuje používat OWASP Application Security Verification Standard (ASVS) jako referenční rámec pro stanovení bezpečnostních požadavků na vaše aplikace.
...
*  Provádějte logování, monitorování a vyhodnocování upozornění (alerting) pro všechny aplikace. Pokud některá z těchto oblastí chybí, doplňte ji.
