...
* **[A01:2025 - Nedostatečné řízení přístupu (Broken Access Control)](A01_2025-Broken_Access_Control.md)** zůstává na 1. místě jako nejzávažnější bezpečnostní riziko aplikací; poskytnutá data ukazují, že v průměru 3,73 % testovaných aplikací mělo jednu nebo více z 40 CWE v této kategorii. Jak je naznačeno přerušovanou čarou na výše uvedeném obrázku, Server-Side Request Forgery (SSRF) bylo do této kategorie zařazeno.
